...
// recalculateProjectDates / recalculateProjectDatesByDueDate retired —
// the DB trigger trg_waterfall_recompute now cascades dates server-side
// whenever start_date / parent_task_id / position / days_from_start
// changes, so the client no longer needs the business-day-shift logic.
